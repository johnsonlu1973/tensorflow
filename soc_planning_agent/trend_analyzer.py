...
**🔵 啟動層：產業趨勢 ──→ 市場新機會**
（「遊戲規則的改變」→「潛在的戰場」浮現）
邏輯：宏觀不可逆轉變打破原有市場平衡，使原本不存在或無利可圖的商業空間出現，且現有競爭者尚未充分滿足。

**🟡 鎖定層：市場新機會 ──→ 痛點**
（「潛在的戰場」→「切入市場的破口」定位）
邏輯：在新商業空間中，目標客戶有特定 JTBD，但現有方案在某個具體環節（速度／精度／成本／架構）上無法妥善處理，形成可切入的痛點。

**🟢 轉換層：痛點 ──→ 客戶價值**
（「切入市場的破口」→「客戶買單的理由」形成）
邏輯：解決方案消除痛點，使客戶的〔總體效益 − 總體成本〕為正，且現有廠商因技術壁壘或結構限制無法提供相同價值。

**🔴 收成層：客戶價值 ──→ 商業價值**
（「客戶買單的理由」→「公司留住的利潤與壁壘」）
邏輯：透過護城河（架構壁壘／生態綁定／高轉換成本）將客戶價值轉化為可持續的財務指標與戰略資產；無護城河則客戶價值無法穩定轉為商業價值。

---

找出 2-3 個最重要的結構性機會。每個機會**必須按四層順序**填寫以下欄位。

⚠️ **輸出格式指令**：將每個欄位括號內的說明替換為你的實際分析內容。不要輸出括號說明本身，不要在欄位之外自行增加段落。所有「→」箭頭必須說明機制（規則二），說不出機制改寫為 [未驗證]。

---

**🔵 啟動層：產業趨勢 ──→ 市場新機會**（「遊戲規則的改變」→「潛在的戰場」浮現）

- 原始觀察：[來源 日期]「引文」— 觀察到：XXX。（列 2-4 個本週具體現象，只列事實，不下結論）
- 導出說明：觀察A ＋ 觀察B → 共同指向 XXX，**機制是**：…→ 因此遊戲規則改變為…。（規則二：每個→必須說明機制；說不出標 [未驗證]；說明趨勢是否長期不可逆，若有反轉風險標 [未驗證]）
- 產業趨勢：（根據上方導出說明陳述趨勢，再確認：① 宏觀—影響整個產業而非單一公司 ② 長期—5年以上驅動力 ③ 不可逆—即使短期受阻仍會繼續；任一無法確認標 [未驗證]）
- 機會邊界：（精確描述商業空間：誰、做什麼、在哪個場景。不能只說「需求增加」）
- 因果回答：（規則二。說明「趨勢改變了什麼具體條件」→「使得這個商業空間此時出現的機制」；說不出機制標 [未驗證]）

**🟡 鎖定層：市場新機會 ──→ 痛點**（「潛在的戰場」→「切入市場的破口」定位）

- 目標客群與 JTBD：（說明目標客戶是誰、試圖完成的具體任務是什麼；確認符合「現有方案無法妥善處理」的定義）
- 因果回答：（規則二。說明在完成此 JTBD 時，現有方案（Qualcomm／MediaTek／OEM）的哪個具體缺陷—速度／精度／成本／架構限制—導致阻礙無法消除，為何無法消除；估計痛點深度與支付意願；泛稱「需求增加」不算；說不出機制標 [未驗證]）

**🟢 轉換層：痛點 ──→ 客戶價值**（「切入市場的破口」→「客戶買單的理由」形成）

- 解決方案：（一句話描述方案）
- 因果回答：（規則二。① 解決方案如何消除痛點（具體技術或商業機制）② 消除後客戶獲得的「總體效益」是什麼（定量優先）③ 客戶須付出的「總體成本（金錢＋時間＋學習）」是多少 ④ 為何效益>成本 ⑤ 為何現有廠商目前無法提供同等客戶價值（技術壁壘／時間窗口／生態位置／成本結構）；若現有廠商能輕易複製標 [未驗證]；每個→說不出機制標 [未驗證]）

**🔴 收成層：客戶價值 ──→ 商業價值**（「客戶買單的理由」→「公司留住的利潤與壁壘」）

- 商業模式：（一句話描述）
- 因果回答：（規則二。① 如何將客戶價值轉化為財務指標＋戰略資產（具體擷取機制）② 定價權從哪裡來（架構壁壘／生態綁定／高轉換成本）③ 護城河如何阻止競爭者複製，會隨時間加深還是消失 ④ 若客戶價值無法轉化為商業價值明確標 [未驗證] 並說明風險；確認商業價值 ≠ 客戶價值；說不出機制標 [未驗證]）
- 預估市場規模與時間窗口：（標記資料時間 [來源：XXX，YYYY.MM]）

---

### ✅ 任務一自我審核（完成四層後必須執行，不得跳過）

逐一列出你在任務一寫過的每一個「→」箭頭，填入下表，並檢查：

| # | 箭頭（A → B） | 機制說明（我寫了什麼） | 通過？ |
|---|-------------|-------------------|------|
| 1 | 觀察 → 趨勢 | （填入你在導出說明中說明的機制） | ✅ / ❌ |
| 2 | 趨勢 → 機會 | （填入你在啟動層因果回答中說明的機制） | ✅ / ❌ |
| 3 | 機會 → 痛點 | （填入你在鎖定層因果回答中說明的機制） | ✅ / ❌ |
| 4 | 痛點 → 客戶價值 | （填入你在轉換層因果回答中說明的機制） | ✅ / ❌ |
| 5 | 客戶價值 → 商業價值 | （填入你在收成層因果回答中說明的機制） | ✅ / ❌ |

**判斷標準**：
- ✅ = 說明了「A 如何透過什麼具體機制導致 B」（有動詞、有因果連結）
- ❌ = 只說「A 和 B 都存在」、「A 帶動 B」、「A 促進 B」等無機制的描述

**若任何欄位為 ❌**：
1. 明確指出是哪個箭頭缺乏機制說明
2. 重新回答該層的因果回答，補充機制；若真的說不出機制，改寫為 [未驗證] 並說明缺什麼資訊才能驗證
3. 不得直接進入任務二，直到所有 ❌ 修正為 ✅ 或標記為 [未驗證]
